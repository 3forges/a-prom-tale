...
Similarly, we can create *client mode* tests to verify the functionalities of simple Jakarta Servlet, Jakarta Faces, Jakarta Pages, etc. The complete codes can be found [here](https://github.com/hantsy/pestoapp).
...
Get the [complete source codes](https://github.com/hantsy/pestoapp) from my Github account.
