...
The newly created [pestoapp](https://github.com/hantsy/pestoapp) project provides a template to create Jakarta EE web applications and deploy to the popular Servlet containers, esp. Apache Tomcat 10.x and Eclipse Jetty 11.x. In this project, I have integrated the following popular Jakarta EE compoenents.
...
Let's explore the integrated features in the [pestoapp](https://github.com/hantsy/pestoapp) repository.

## Configuration

To prepare a project used in the next stpes, clone the source codes of [pestoapp](https://github.com/hantsy/pestoapp) repository or create a new Maven webapp through [Maven Webapp Archetype](https://maven.apache.org/archetypes/maven-archetype-webapp/). 
...
Go to http://localhost:8080/pestoapp/GreetingServlet?name=Hantsy to view the Servlet example.

![Servlet](./servlet.png)

Open http://localhost:8080/pestoapp/GreetingPagesServlet?name=Hantsy to see the result of Jakarta Server Pages. 

![Pages](./pages.png)

Navigate to http://localhost:8080/pestoapp/hello.xhtml and input name, and click the Greeting button, you will see the following result. 

![Faces](./faces.png)

Access http://localhost:8080/pestoapp/api/greeting/Hantsy in your browser or using `curl` command, you will see the following result.
...
Check [the complete example codes](https://github.com/hantsy/pestoapp) from My Github.