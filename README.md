...
cat <<EOF >~/vault.key.sh
#!/bin/bash
echo \$ANSIBLE_VAULT_MASTER_KEY
EOF
chmod +x ~/vault.key.sh

# ---
# Then all you need is to
# set the value of the ANSIBLE_VAULT_MASTER_KEY
# pipeline env. var. and you're good to go.
